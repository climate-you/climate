...
def _iter_geonames_rows(
    ...
    Returns tuples:
      (geonameid, name, country_code, lat, lon, timezone, population, feature_code)
    """
        ...
        with z.open(inner, "r") as bf:
            ...
            for line in tf:
                ...
                try:
                    ...
                    continue
                yield geonameid, name, cc, lat, lon, timezone, population, feature_code
...
def write_locations_csv(
    ...
    *,
    ...
    with open(out_csv, "w", encoding="utf-8", newline="") as f:
        ...
        w.writeheader()
        for geonameid, name, cc, lat, lon, tz, pop, _ in _iter_geonames_rows(
